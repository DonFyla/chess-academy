...
-- Drop existing functions if they exist (to fix return type conflicts)
...
-- Function 1: Check if a slot is available
...
-- Function 2: Get unified schedule (simpler version)
