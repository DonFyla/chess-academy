-- Fix: Add special_bookings to conflict detection
-- This migration updates the is_slot_available and get_coach_unified_schedule functions
-- to include special_bookings in their checks

-- Function: Check if a slot is available (updated to include special_bookings)
...
-- Function: Get unified schedule (updated to include special_bookings)
