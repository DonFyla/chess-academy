import IntermediateAboutCourseCard from '../cards/IntermediateAboutCard';
import IntermediateTutorList from '../cards/IntermediateTutorList';

export default function IntermediateCourseDetailPage() {
    return (
